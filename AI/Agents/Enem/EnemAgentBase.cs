...
/// </summary>
public abstract class EnemAgentBase<TIn, TOut> : AgentBase<TIn, TOut>
{
    protected EnemAgentBase(
        ...
        ILogger                                        logger)
        : base(chatClient, embeddingGen, vectorStore, promptProvider,
...
/// </summary>
public abstract class EnemTextAgent<TIn> : EnemAgentBase<TIn, string>
{
    protected EnemTextAgent(
        IChatClient                                    chatClient,
        IEmbeddingGenerator<string, Embedding<float>> embeddingGen,
        IVectorStore                                   vectorStore,
        IPromptProvider                                promptProvider,
