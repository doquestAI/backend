...
internal sealed class IngestDocumentCommandHandler(
    ...
    : IRequestHandler<IngestDocumentCommand, Result<IngestDocumentResponse>>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        return Result.Success(new IngestDocumentResponse(document.Id, document.Title.Value, document.Chunks.Count));
    }
}
