...
internal static class PipelineTelemetry
{
    ...
    internal static readonly Counter<long> PipelineExecutions =
    ...
    // ── Contadores de Step ──────────────────────────────────────────────
    internal static readonly Counter<long> StepExecutions =
        _meter.CreateCounter<long>(
            "pipeline.step.executions",
            unit: "{executions}",
            description: "Número total de execuções de steps.");

    internal static readonly Counter<long> StepFailures =
        _meter.CreateCounter<long>(
